...
public class Televisore{
   ...
   //addizionale
    ...
    public String toString(){
        String out="";
        out+=" pollici : '"+this.pollici; 
        out+="' schermo : "+this.schermo;
        out+=", colore : "+this.colore;
        System.out.println(); 
        out+=", canale : "+this.canale;  
        out+=", volume impostato : "+this.volume; 
